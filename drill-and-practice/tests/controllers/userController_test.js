...
describe('TEST - userController', async () => {
	...
	it('GET /auth/logout - userController.logout', async () => {
	...
	it('GET /auth/login - userController.viewLogin', async () => {
	...
	it('GET /auth/register - userController.viewRegistration', async () => {
